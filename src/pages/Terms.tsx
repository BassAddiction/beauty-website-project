      ...
      <main className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              1.2. Акцепт (принятие) Оферты осуществляется путем оплаты услуг через сайт onproduct.pro или speedvpn.io 
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              <li>Месячная подписка — 249 ₽/месяц</li>
              <li>Квартальная подписка — 649 ₽ (217 ₽/месяц)</li>
              <li>Годовая подписка — 1999 ₽ (167 ₽/месяц)</li>
            </ul>
