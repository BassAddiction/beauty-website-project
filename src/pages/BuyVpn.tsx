          ...
          <article className="prose prose-lg max-w-none">
            ...
            <div className="bg-green-500/10 border-l-4 border-green-500 rounded-r-xl p-6 my-12">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    При покупке на 6 месяцев экономия 15%, на год — 24%. Чем дольше срок, тем выгоднее цена за месяц.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <details className="group bg-card rounded-xl p-6 border cursor-pointer">
                ...
                <p className="text-muted-foreground mt-4">
                  Самый выгодный — годовой (60₽/месяц, экономия 24%). Но если пробуете впервые — возьмите месяц за 79₽, оцените качество, потом купите длинную подписку.
                </p>
              </details>
            ...
            <div className="mt-12 p-8 bg-gradient-to-br from-primary to-purple-600 rounded-2xl text-white text-center">
              ...
              <p className="text-lg mb-6 opacity-90">
                От 79₽/месяц. Оплата российскими картами. Мгновенная активация.
              </p>
              <Link 
                to="/#pricing" 
